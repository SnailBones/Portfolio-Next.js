...
As a longtime forager, I've always been excited about learning about the uses of the plants around me and incorporating them into my cooking. In my hometown of Albuquerque, New Mexico, an abundance of food producing plants go greatly underutilized, including numerous **introduced species**, the harvesting of which can provide free food while _benefitting_ biodiversity. I conceived of Forage Albuquerque as a project to **unblock access these hyper-local, sustainable food sources**.

Through informal interviews with prospective foragers, I learned that key barriers to foraging are:
...
I started work on Forage Albuquerque in August 2023, as my first major **React** project. Having previously worked with Vue.js and Angular, I found the JSX syntax elegant and fun. I was able to further enhance my speed of iteration by working with GPT-4, which had recently come out at the time.
